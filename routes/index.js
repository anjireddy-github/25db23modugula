...
router.get('/', function (req, res) {
  res.render('index', { title: 'Concert App', user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Concert App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Concert App Login', user : req.user });
});
